...
//****************************************************************************80
template<class intT, class realT, template<class, class> class PDET>
class GLSResidual {

private:
  PDET<intT,realT>& PDE; /*!< Reference to PDE class already instantiated */
  Solution<intT,realT>& soln; /*!< Reference to solution class already 
				instantiated. */
  UnstGrid<intT,realT>& grid; /*!< Reference to grid class already 
				instantiated. */
...
//****************************************************************************80
  GLSResidual(PDET<intT,realT> & PDE_ref, UnstGrid<intT, realT>& grid_ref, 
