...
TEST(SurrealLog10, Log10OfSurreal) {
  ...
  c = log10(a);
  //test value
  EXPECT_DOUBLE_EQ(std::log10(100.0), c.Value());
  //test derivatives
  EXPECT_DOUBLE_EQ( 1.0/100.0 / log(10.0)* 2.0, c.Deriv(0));
  EXPECT_DOUBLE_EQ( 1.0/100.0 / log(10.0)* 3.0, c.Deriv(1));
  EXPECT_DOUBLE_EQ( 1.0/100.0 / log(10.0)* 4.0, c.Deriv(2));
}
...
TEST(SurrealFabs, FabsofSurreal) {
  ...
  c = fabs(a);
  //test value
  EXPECT_DOUBLE_EQ(std::fabs(2.0), c.Value());
  //test derivatives
  EXPECT_DOUBLE_EQ(2.0, c.Deriv(0));
  EXPECT_DOUBLE_EQ(3.0, c.Deriv(1));
  EXPECT_DOUBLE_EQ(4.0, c.Deriv(2));
